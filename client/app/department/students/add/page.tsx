  ...
  const handlePreview = async () => {
    ...
    if (selectedFile.name.endsWith(".csv")) {
      try {
        ...
        if (lines.length > 0) {
          ...
          const required = [
            ...
            "department", "program", "year", "section", "enrollment_date"
          ]
          // Make sure at least the crucial ones exist, others can be blank
          const crucial = ["student_id", "first_name", "last_name", "department", "year", "section"]
      ...
      setTimeout(() => {
        setIsUploading(false)
        setPreviewData([
          { student_id: "CS001", first_name: "Mock", last_name: "Excel Data", department: "Computer Science", year: "4th Year", section: "A", email: "mock@example.com" },
          { student_id: "CS002", first_name: "Test", last_name: "User", department: "Computer Science", year: "1st Year", section: "B", email: "test@example.com" },
        ])
        setIsOpen(false)
      }, 1000)
    }
  ...
  const handleConfirm = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Import Successful", {
        description: `Successfully created students from ${selectedFile?.name}.`,
      })
    }, 1500)
  }
      ...
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Create a student profile for the department management system.
          </p>
        </div>
        ...
        <Dialog open={isOpen} onOpenChange={resetModal}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload an Excel (.xlsx) or CSV file containing student records.
              </DialogDescription>
            </DialogHeader>
            <div 
            ...
            {parseError ? (
              ...
              <Alert className="mt-4">
                ...
                <AlertDescription className="text-xs">
                  Ensure your file has 14 columns matching the manual form: <code className="bg-muted px-1 py-0.5 rounded">student_id</code>, <code className="bg-muted px-1 py-0.5 rounded">first_name</code>, <code className="bg-muted px-1 py-0.5 rounded">last_name</code>, <code className="bg-muted px-1 py-0.5 rounded">department</code>, <code className="bg-muted px-1 py-0.5 rounded">year</code>, <code className="bg-muted px-1 py-0.5 rounded">section</code>, etc.
                </AlertDescription>
              </Alert>
            )}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={handleConfirm} disabled={isUploading}>
                {isUploading ? "Creating Students..." : "Confirm & Create All Students"}
              </Button>
            </div>
          </div>
